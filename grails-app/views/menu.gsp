...
<html>
  ...
  <body>
  <p><font color="blue">This is the menu page for PFM</font></p>
    <h1><a href="index.gsp" target="_blank">Grails main page to see all the data changes</a></h1>
    <h1><a href="map1.gsp" target="_blank">Map1</a></h1>
    <h1><a href="map2.gsp" target="_blank">Map2</a></h1>
